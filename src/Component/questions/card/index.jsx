  ...
  return (
    <div onClick={text} className="question__card-wrapper">
      ...
      <p className="question__text">
        ...
        qo’yganmiz. Ma’lumotlar bazasini xafvsiz ta’minlash uchun sizning o’quv
        markazingiz va kompaniyamiz o’rtasida sirlarni saqlash uchun maxfiylik
        siyosati nomli shartnoma imzolanadi. Bu orqali sizning
        ma’lumotlaringizni oshkora qilmaslik majburiyatini bizning kompaniyamiz
        oladi.
      </p>
    </div>
  );
